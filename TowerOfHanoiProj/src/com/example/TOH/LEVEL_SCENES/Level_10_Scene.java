...
public class Level_10_Scene extends Scene{
	...
	public Level_10_Scene()
	{
		...
		levelBgTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(levelBgAtlas,activity.getBaseContext(),"gold.png",0,0);
