...
public class Level_07_Scene extends Scene{

	private BitmapTextureAtlas levelBgAtlas;
	private ITextureRegion levelBgTextureRegion;
	
	BitmapTextureAtlas levelTextureAtlas;
	private ITextureRegion mTowerTextureRegion, mRing1, mRing2, mRing3, mRing4, mRing5,mRing6, mRing7, mRing8, mRing9;
	...
	public Level_07_Scene()
	{
		...
		levelBgTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(levelBgAtlas,activity.getBaseContext(),"level7.png",0,0);
        ...
        if(mStack3.size() == 9){
                activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mydb.addScore(7, 9, moves, formattedTimeString);
                            mydb.close();
