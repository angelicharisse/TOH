...
public class Level_05_Scene extends Scene{

	private BitmapTextureAtlas levelBgAtlas;
	private ITextureRegion levelBgTextureRegion;
	
	BitmapTextureAtlas levelTextureAtlas;
	private ITextureRegion mTowerTextureRegion, mRing1, mRing2, mRing3, mRing4, mRing5,mRing6, mRing7;
	...
	public Level_05_Scene()
	{
		...
		levelBgTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(levelBgAtlas,activity.getBaseContext(),"level5.png",0,0);
	...
	public void loadResources()
	{
		...
		levelTextureAtlas = new BitmapTextureAtlas(activity.getTextureManager(), 800, 480);
		 ...
		 try {
	            ...
	            this.mRing7 = TextureRegionFactory.extractFromTexture(ring6Texture);
	            // 4 - Create the stacks
        ...
        if(mStack3.size() == 7){
                activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mydb.addScore(5, 7, moves, formattedTimeString);
                            mydb.close();
