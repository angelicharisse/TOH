...
public class Level_04_Scene extends Scene{
	
	private BitmapTextureAtlas levelBgAtlas;
	private ITextureRegion levelBgTextureRegion;
	
	BitmapTextureAtlas levelTextureAtlas;
	private ITextureRegion mTowerTextureRegion, mRing1, mRing2, mRing3, mRing4, mRing5,mRing6;
	...
	public Level_04_Scene()
	{
		...
		levelBgTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(levelBgAtlas,activity.getBaseContext(),"rainbow.png",0,0);
        ...
        if(mStack3.size() == 6){
                activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mydb.addScore(4, 6, moves, formattedTimeString);
                            mydb.close();
