...
public class Level_06_Scene extends Scene{

	private BitmapTextureAtlas levelBgAtlas;
	private ITextureRegion levelBgTextureRegion;
	
	BitmapTextureAtlas levelTextureAtlas;
	private ITextureRegion mTowerTextureRegion, mRing1, mRing2, mRing3, mRing4, mRing5,mRing6, mRing7, mRing8;
	...
	public Level_06_Scene()
	{
		...
		levelBgTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(levelBgAtlas,activity.getBaseContext(),"level6.png",0,0);
        ...
        if(mStack3.size() == 8){
                activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                                ...
                                mydb.addScore(6, 8, moves, formattedTimeString);
                                mydb.close();
