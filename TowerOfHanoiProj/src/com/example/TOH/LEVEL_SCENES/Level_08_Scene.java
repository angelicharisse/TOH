...
public class Level_08_Scene extends Scene{

	private BitmapTextureAtlas levelBgAtlas;
	private ITextureRegion levelBgTextureRegion;
	
	BitmapTextureAtlas levelTextureAtlas;
	private ITextureRegion mTowerTextureRegion, mRing1, mRing2, mRing3, mRing4, mRing5,mRing6, mRing7, mRing8, mRing9, mRing10;
	...
	public Level_08_Scene()
	{
		...
		levelBgTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(levelBgAtlas,activity.getBaseContext(),"level8.png",0,0);
	...
	public void loadResources()
	{
		...
		levelTextureAtlas = new BitmapTextureAtlas(activity.getTextureManager(), 800, 480);
		 ...
		 try {
	            ...
	            ITexture ring1Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_1.png");
	                }
	            });
	            ITexture ring2Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_2.png");
	                }
	            });
	            ITexture ring3Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_3.png");
	                }
	            });
	            ITexture ring4Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_4.png");
	                }
	            });
	            ITexture ring5Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_5.png");
	                }
	            });
	            ITexture ring6Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_6.png");
	                }
	            });
	            ITexture ring7Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_7.png");
	                }
	            });
	            ITexture ring8Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_8.png");
	                }
	            });
	            ITexture ring9Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_9.png");
	                }
	            });
	            ITexture ring10Texture = new BitmapTexture(activity.getTextureManager(), new IInputStreamOpener() {
	                public InputStream open() throws IOException {
	                    return activity.getAssets().open("gfx/lvl_8_ring_10.png");
	                }
	            });
	            ...
	            this.mRing6 = TextureRegionFactory.extractFromTexture(ring6Texture);
	            this.mRing7 = TextureRegionFactory.extractFromTexture(ring7Texture);
	            this.mRing8 = TextureRegionFactory.extractFromTexture(ring8Texture);
	            this.mRing9 = TextureRegionFactory.extractFromTexture(ring8Texture);
	            this.mRing10 = TextureRegionFactory.extractFromTexture(ring8Texture);
	            // 4 - Create the stacks
		...
		// 2 - Add the towers
			...
			// 3 - Create the rings
			Ring ring1 = new Ring(1, 136, 151, this.mRing1, activity.getVertexBufferObjectManager()) {
			    @Override
			...
			Ring ring2 = new Ring(2, 127, 179, this.mRing2, activity.getVertexBufferObjectManager()) {
			    @Override
			    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
			            return false;
			...
			Ring ring3 = new Ring(3, 110, 211, this.mRing3, activity.getVertexBufferObjectManager()) {
			    @Override
			    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
			            return false;
			...
			Ring ring4 = new Ring(4, 100, 245, this.mRing4, activity.getVertexBufferObjectManager()) {
				 @Override
				    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
				        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
				            return false;
			...
			Ring ring5 = new Ring(5, 87, 279, this.mRing5, activity.getVertexBufferObjectManager()) {
			    @Override
			    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
			            return false;
			...
			Ring ring6 = new Ring(6,78, 319, this.mRing6, activity.getVertexBufferObjectManager()) {
			    @Override
			    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
			            return false;
			...
			Ring ring7 = new Ring(7,69, 359, this.mRing7, activity.getVertexBufferObjectManager()) {
			    @Override
			    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
			            return false;
			...
			Ring ring8 = new Ring(8,60, 319, this.mRing8, activity.getVertexBufferObjectManager()) {
			    @Override
			    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
			            return false;
			...
			Ring ring9 = new Ring(9,51, 279, this.mRing9, activity.getVertexBufferObjectManager()) {
			    @Override
			    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
			            return false;
			...
			Ring ring10 = new Ring(10,42, 239, this.mRing10, activity.getVertexBufferObjectManager()) {
			    @Override
			    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			        if (((Ring) this.getmStack().peek()).getmWeight() != this.getmWeight())
			            return false;
			...
			this.attachChild(ring6);
			this.attachChild(ring7);
			this.attachChild(ring8);
			this.attachChild(ring9);
			this.attachChild(ring10);
			// 4 - Add all rings to stack one
			this.mStack1.add(ring10);
			this.mStack1.add(ring9);
			this.mStack1.add(ring8);
			this.mStack1.add(ring7);
			...
			ring7.setmStack(mStack1);
			ring8.setmStack(mStack1);
			ring9.setmStack(mStack1);
			ring10.setmStack(mStack1);
			...
			ring7.setmTower(mTower1);
			ring8.setmTower(mTower1);
			ring9.setmTower(mTower1);
			ring10.setmStack(mStack1);
			...
			this.registerTouchArea(ring6);
			this.registerTouchArea(ring7);
			this.registerTouchArea(ring8);
			this.registerTouchArea(ring9);
			this.registerTouchArea(ring10);
        ...
        if(mStack3.size() == 10){
                activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mydb.addScore(8, 10, moves, formattedTimeString);
                            mydb.close();
